          <nav>
            <ul>
              ...
              <a href="Contenido2"><li><i class="fa fa-archive" aria-hidden="true"></i> Contenido*2</li></a>
              <a href="#"><li><i class="fa fa-question-circle-o" aria-hidden="true"></i> Información</li></a>
              <a href="#"><li><i class="fa fa-cogs" aria-hidden="true"></i> Configuraciones</li></a>
            </ul>
          </nav>
